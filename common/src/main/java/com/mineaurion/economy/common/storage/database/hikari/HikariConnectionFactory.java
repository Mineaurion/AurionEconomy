package com.mineaurion.economy.common.storage.database.hikari;

import com.mineaurion.economy.common.misc.StorageCredentials;
import com.mineaurion.economy.common.plugin.EconomyPlugin;
import com.mineaurion.economy.common.storage.database.ConnectionFactory;
...
public abstract class HikariConnectionFactory implements ConnectionFactory {
    ...
    */
    ...
    @Override
    public void init(EconomyPlugin plugin){
        HikariConfig config;
        try {
