...
public class InitHelp {
	...
	public static void init() {
		...
		Usage usagegive = new Usage(Argument.of("<player>","Nom du joueur à qui tu veut modifier la balance"))
				.addArgument(Argument.of("<montant>","montant à donné"));
		...
		Usage usagetake = new Usage(Argument.of("<player>","Nom du joueur à qui tu veut modifier la balance"))
				.addArgument(Argument.of("<montant>","montant à donné"));
		...
		Usage usageset = new Usage(Argument.of("<player>","Nom du joueur à qui tu veut modifier la balance"))
				.addArgument(Argument.of("<montant>","montant à donné"));
		...
		Usage usageinfinite = new Usage(Argument.of("<player>","Nom du joueur à qui tu veut modifier la balance"));
		Help infinite = new Help("money infinite","infinite","Done une balance illimité")
				.setPermission("economie.money.admin")
				.setUsage(usageinfinite)
				.addExample("/money infinite THEJean_Kevin");
		Help.register(infinite);
		
		Usage usagelog = new Usage(Argument.of("[player]","Nom du joueur à qui tu veut voir les transaction")).addArgument(Argument.of("[page]","page"));
		...
		Usage usageCheck = new Usage(Argument.of("<player>","Nom du joueur que tu veut check"))
				.addArgument(Argument.of("<montant>","montant à check"))
